    ...
    <DialogContent>
      <FormControl component="fieldset">
        ...
        <RadioGroup value={props.evaluationArg.rank.sourceRank} onChange={props.onChangeSourceRank}>
          ...
          <FormControlLabel value="A" control={<Radio disableRipple={true} />} label={provideContent("A", [data_A_digest_en, data_A_0_en, data_A_1_en])}/>
          <Divider variant="middle" />
          <FormControlLabel value="B" control={<Radio disableRipple={true} />} label={provideContent("B", [data_B_digest_en, data_B_0_en, data_B_1_en])}/>
          <Divider variant="middle" />
          <FormControlLabel value="C" control={<Radio disableRipple={true} />} label={provideContent("C", [data_C_digest_en, data_C_0_en, data_C_1_en])}/>
          <Divider variant="middle" />
          <FormControlLabel value="D" control={<Radio disableRipple={true} />} label={provideContent("D", [data_D_digest_en, data_D_0_en, data_D_1_en])}/>
          <Divider variant="middle" />
      ...
      <FormControl component="fieldset">
        ...
        <RadioGroup value={props.evaluationArg.rank.infoRank.toString()} onChange={props.onChangeInfoRank}>
          ...
          <Divider variant="middle" />
          <FormControlLabel value={String(1)} control={<Radio disableRipple={true} />} label={provideContent(String(1), [data_1_digest_en, data_1_0_en, data_1_1_en, data_1_2_en])}/>
          <Divider variant="middle" />
          <FormControlLabel value={String(2)} control={<Radio disableRipple={true} />} label={provideContent(String(2), [data_2_digest_en, data_2_0_en, data_2_1_en, data_2_2_en])}/>
          <Divider variant="middle" />
          <FormControlLabel value={String(3)} control={<Radio disableRipple={true} />} label={provideContent(String(3), [data_3_digest_en, data_3_0_en, data_3_1_en, data_3_2_en])}/>
          <Divider variant="middle" />
          <FormControlLabel value={String(4)} control={<Radio disableRipple={true} />} label={provideContent(String(4), [data_4_digest_en, data_4_0_en, data_4_1_en, data_4_2_en])}/>
          <Divider variant="middle" />
